...
This module creates and configures the Flask Blueprint for the student-specific
...
# Create a Blueprint instance for the 'student' module.
# Blueprints help in organizing a Flask application into smaller, reusable components.
student = Blueprint('student', __name__)

# Import the routes defined within the 'student' blueprint.
